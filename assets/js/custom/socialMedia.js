var socialMediaIcos = {
	...
	addIconsSocial = function (a, o) {
		for (var e = document.querySelectorAll('a[href*="' + a + '"]'), i = 0; i < e.length; i++) e[i].previousElementSibling.classList.add("" + o)
	},
	iterarIcosSocialMedia = function (a) {
		for (var o in a) addIconsSocial(o, a[o])
	};
